...
module.exports.signUpNewUser = async (req, res) => {
   try {
    let { username, email, password ,profession, phone } = req.body;
    console.log(username, email, password ,profession, phone);
    const newUser = new user({ email, username, profession, phone })
