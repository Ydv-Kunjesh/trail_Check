...
router.post("/new",isLoggedIn,listingvalidator,upload.single('listing[image]'),wrapAsync(listingController.addingNewListing)
)
...
// // route for get all my listing 
// // Example route for retrieving user listings
router.get("/my-listings", wrapAsync , listingController.getUserListings);
